...
scoreFont = pygame.font.SysFont("Ebrima", 18)
scoreText = scoreFont.render("Score: " + str(int(totalScore1)).zfill(2), True, (255, 255, 255))
finalScreen = pygame.font.SysFont("Ebrima", 25)
...
while running:
    ...
    if not left_pot.render_text is None:
        font = pygame.font.SysFont('Ebrima', 15)
    ...
    scoreText1 = scoreFont.render("player 1: " + str(int(totalScore1)), True, (255, 255, 255))
    screen.blit(scoreText1, (790, 60)) # adjust situation
    scoreText2 = scoreFont.render("player 2: " + str(int(totalScore2)), True, (255, 255, 255))
